Experiment completed at 2025-12-08 20:46:53.008604+00:00 (total experiment time: 5s, total rows: 10).

This file describes the conditions for the runs captured in sleep_fast.csv. The measurements were run on etc2, starting at 2025-12-08 20:46:47.824308+00:00 (UTC).
SHARP version: 4.0.0
...
```json
{
  "cpu": {
    ...
    "scaling_cur_freq_khz": "1500547",
    "architecture": "x86_64"
  },
  "memory": {
    "total_memory_kb": "1056554032",
    "available_memory_kb": "1024243772",
    "free_memory_kb": "993113772",
    "cached_memory_kb": "32227964",
    "swap_total_kb": "0",
    "swap_free_kb": "0"
  },
  "gpu": {
  ...
  "system": {
    "uptime_seconds": "3291975",
    "running_processes": "1837",
    "hostname": "etc2"
  }
}
```
