Experiment completed at 2025-12-08 20:47:27.026010+00:00 (total experiment time: 6s, total rows: 10).

This file describes the conditions for the runs captured in sleep_slow.csv. The measurements were run on etc2, starting at 2025-12-08 20:47:20.914474+00:00 (UTC).
SHARP version: 4.0.0
SHARP's source code version used was from git hash: 63c95a4
Executable checksum (sha256): bd5a98ed1...
...
```json
{
  ...
  "mpl": 1,
  "entry_point": "/home/frachten/sharp/build/appimages/sleep-x86_64.AppImage",
  "args": [
    "0.2"
  ],
  "task": "sleep_slow",
...
```json
{
  "cpu": {
    ...
    "scaling_cur_freq_khz": "1793985",
    "architecture": "x86_64"
  },
  "memory": {
    "total_memory_kb": "1056554032",
    "available_memory_kb": "1023769300",
    "free_memory_kb": "992639068",
    "cached_memory_kb": "32219224",
    "swap_total_kb": "0",
    "swap_free_kb": "0"
  },
  "gpu": {
  ...
  "system": {
    "uptime_seconds": "3292009",
    "running_processes": "1842",
    "hostname": "etc2"
  }
}
```
