Experiment completed at 2025-12-09 02:10:08.761093+00:00 (total experiment time: 1s, total rows: 3).

This file describes the conditions for the runs captured in sleep.csv. The measurements were run on etc2, starting at 2025-12-09 02:10:06.803511+00:00 (UTC).
SHARP version: 4.0.0
...
```json
{
  "cpu": {
    ...
    "scaling_cur_freq_khz": "1499458",
    "architecture": "x86_64"
  },
  "memory": {
    "total_memory_kb": "1056554032",
    "available_memory_kb": "1023677188",
    "free_memory_kb": "992358200",
    "cached_memory_kb": "32387848",
    "swap_total_kb": "0",
    "swap_free_kb": "0"
  },
  "gpu": {
  ...
  "system": {
    "uptime_seconds": "3311371",
    "running_processes": "1830",
    "hostname": "etc2"
  }
}
```
