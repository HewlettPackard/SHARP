#!/usr/bin/env python3
r"""
Synthetic distribution generator for repeater testing (NOT a benchmark).

Produces synthetically generated outputs based on a chosen distribution.

This module generates samples from several parametrized distributions,
providing a synthetic fixture for testing SHARP repeater stopping criteria.
